...
import { DomCaptureService } from "../../src/slack/domCaptureService.js";

const asString = (value: unknown): string | undefined =>
  typeof value === "string" && value !== "" ? value : undefined;

describe("DomCaptureService", () => {
  it("capture 成功後に consume で text/channel を取得できる", async () => {
  ...
  it("capture 失敗時は consume が null を返し debugDetailed なら失敗ログを残す", async () => {
