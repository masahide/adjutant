module github.com/cyg-infra/adjutant

go 1.24.4

require (
	github.com/korotovsky/slack-mcp-server v0.0.0
...
require (
	...
	github.com/rusq/slackdump/v3 v3.1.13 // indirect
...
replace github.com/korotovsky/slack-mcp-server => ./vendor/slack-mcp-server
